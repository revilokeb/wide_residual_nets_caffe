...
def make_net():
    with open('wrn_ilsvrc_151_v7.prototxt', 'w') as f:
        print(wrn_ilsvrc('/PATH/TO/train_imagenet_156_lmdb', '/PATH/TO/val_imagenet_156_lmdb'), file=f)

if __name__ == '__main__':
    make_net()
    caffe.Net('wrn_ilsvrc_151_v7.prototxt', caffe.TEST)  # test loading the net